...
def main():
    ...
    # print (args.minprob)
    # sys.exit()
    add_intrachain_rst(npz, rst, tmpdir, params, minprob=args.minprob, UB=args.intradist, D=args.intrasd,
                       allcontacts=args.allcontacts)  # Adding a weak flat harmonic to bring things together.
