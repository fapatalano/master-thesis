...
def get_args(params):
    ...
    parser.add_argument('-minprob', type=float, dest='minprob', default=0.5,
                        help='min probability of distance restraints for inter-chain flat harminic')
    parser.add_argument('-intradist', type=float, dest='intradist', default=15.,
                        help='The distance for the flat part in  restraints for inter-chain flat harmonic')
    parser.add_argument('-intrasd', type=float, dest='intrasd', default=20.,
                        help='SD for  restraints for inter-chain flat harminic')
    parser.add_argument('-allintra', dest='allcontacts',
                        help='Use in additiona also a weak interacting potential for all intrachain contacts',
                        action='store_true')
    ...
    parser.add_argument('-dock', type=str, dest='dockingmode', default="A", choices=["A", "B", "C", "D"],
                        help="Docking mode", nargs="+")
